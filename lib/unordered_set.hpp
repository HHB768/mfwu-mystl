...
public:
    ...
    using hashtable = mfwu::shashtable<Key, Hasher, Alloc>;
    using iterator = typename hashtable::iterator;

    unordered_set() : htbl_() {}
    unordered_set(size_type capacity) : htbl_(capacity) {}
    ...
    unordered_set(InputIterator first, InputIterator last) 
        : htbl_(first, last) {}
    unordered_set(const std::initializer_list<value_type>& vals)
        : htbl_(vals) {}
    unordered_set(const unordered_set& s) : htbl_(s.htbl_) {}
    unordered_set(unordered_set&& s) : htbl_(mfwu::move(s.htbl_)) {}
    ~unordered_set() {}
    ...
    unordered_set& operator=(unordered_set&& s) {
...
Alloc unordered_set<Key, Hash, Alloc>::allocator_ = {};
template <typename Key, typename Hash, typename Alloc>
Hash unordered_set<Key, Hash, Alloc>::hash_ = {};
