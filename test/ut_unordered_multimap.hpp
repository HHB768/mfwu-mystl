#define __UNIT_TEST_UNORDERED_MULTIMAP__
...
public:
    ...
    using test_map = mfwu::unordered_multimap<data, int, data_hash>;

    bool use_mfwu_unordered_multimap();
    bool use_modifier_and_lookup();
    bool use_other_interface();
private:
    mfwu::unit_test_hashtable_exp ut_hashtable = {};
    template <typename Key, typename Value, typename Hash, typename Alloc>
    void print_unordered_multimap(
        const unordered_multimap<Key, Value, Hash, Alloc>& map) {
#ifdef __UNIT_TEST_UNORDERED_MULTIMAP__
#ifndef __UNIT_TEST_UNORDERED_MULTIMAP_BRIEF__
        ut_hashtable.print_hashtable(map.htbl_);
#endif  // __UNIT_TEST_UNORDERED_MULTIMAP_BRIEF__
#endif  // __UNIT_TEST_UNORDERED_MULTIMAP__
    }
    template <typename Key, typename Value, typename Hash, typename Alloc>
    void print_ret_info(
        typename unordered_multimap<Key, Value, Hash, Alloc>::iterator it,
        bool is_new) {
#ifdef __UNIT_TEST_UNORDERED_MULTIMAP__
#ifndef __UNIT_TEST_UNORDERED_MULTIMAP_BRIEF__
    ...
    template <typename Key, typename Value, typename Hash, typename Alloc>
    void print_unordered_multimap_with_iterator(
        const unordered_multimap<Key, Value, Hash, Alloc>& map) {
    ...
    template <typename Key, typename Value, typename Hash, typename Alloc>
    void print_unordered_multimap_other_info(
        const unordered_multimap<Key, Value, Hash, Alloc>& map) {
#ifdef __UNIT_TEST_UNORDERED_MULTIMAP__
#ifndef __UNIT_TEST_UNORDERED_MULTIMAP_BRIEF__
...
};  // endof class unit_test_unordered_multimap

bool unit_test_unordered_multimap::use_mfwu_unordered_multimap() {
    std::cout << "\n------- Test: use mfwu::unordered_multimap -------\n";
    std::cout << "constructing & copying & moving & destroying\n";
    // using test_map = mfwu::unordered_multimap<data, int, data_hash>;
    test_map map1;
    print_unordered_multimap(map1);
    mfwu::unordered_multimap<data, bool, data_hash> map2(10);
    // print_unordered_multimap(map2);
    test_map map3 = {{data{1}, 2}, 
                     {data{2}, 3}, 
                     {data{3}, 4}, 
                     {data{5}, 6}};
    print_unordered_multimap(map3);
    test_map map4(++map3.begin(), map3.end());
    print_unordered_multimap(map4);
    test_map map5 = map4;
    print_unordered_multimap(map5);
    test_map map6 = mfwu::move(map5);
    print_unordered_multimap(map6);
    mfwu::unordered_multimap<int, int> map7 = {{1, 2}, {3, 4}};
    print_unordered_multimap(map7);
    mfwu::unordered_multimap<int, int, int_hash> map8(map7);
    print_unordered_multimap(map8);
    map4 = map6;
    map4 = mfwu::move(map6);
    print_unordered_multimap(map4);
...
bool unit_test_unordered_multimap::use_modifier_and_lookup() {
    ...
    print_ret_info<data, int, data_hash, mfwu::DefaultAllocator<
        mfwu::bucket_exp<data, int>, mfwu::malloc_alloc>>(it, res);
    print_unordered_multimap(map1);
    ...
    print_ret_info<data, int, data_hash, mfwu::DefaultAllocator<
        mfwu::bucket_exp<data, int>, mfwu::malloc_alloc>>(it2, res2);
    print_unordered_multimap(map1);
    it = map1.erase(it2);
    if (it != map1.end()) {
        print_it_info<data, int, data_hash, mfwu::DefaultAllocator<
            mfwu::bucket_exp<data, int>, mfwu::malloc_alloc>>(it);
    }
    res = map1.erase(data{5});
    print_suc_info<data, int, data_hash, mfwu::DefaultAllocator<
        mfwu::bucket_exp<data, int>, mfwu::malloc_alloc>>(res);
...
bool unit_test_unordered_multimap::use_other_interface() {
    ...
    print_unordered_multimap_with_iterator(map1);
    print_unordered_multimap_other_info(map1);
